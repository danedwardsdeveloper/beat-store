...
export const metadata: Metadata = {
  title: 'Account | Beat Store',
}

// cspell:disable
export default function SignedInAccountPage() {
  return (
    <div className="sm:mx-auto sm:w-full sm:max-w-2xl py-12">
      <div className="px-4 sm:px-0">
        <h3 className="text-base/7 font-semibold text-white">Account details</h3>
        <p className="mt-1 max-w-2xl text-sm/6 text-gray-400">Personal details and order history</p>
      </div>
